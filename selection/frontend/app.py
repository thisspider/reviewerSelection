...
expander_references.write(references)

expander_openalex_works = st.expander("OpenAlex works")
expander_openalex_works.write(st.session_state.openalex_works)

expander_candidate_works = st.expander("Candidate works")
expander_candidate_works.write(st.session_state.candidate_works)
