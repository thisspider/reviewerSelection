...
GCP_SERVICE_ACCOUNT_JSON = os.getenv(
    ...
    str((Path(__file__).parents[2] / ".bootcamp-396314-bdb82af212a9.json").resolve()),
)
...
def load_data_from_bigquery(
    path: Path,
    query: str = "SELECT * FROM bootcamp-396314.all_works.sociology",
) -> pd.DataFrame:
    """
...
if __name__ == "__main__":
    data = pd.read_csv("/Users/tytus/code/thisspider/reviewerSelection/raw_data/all_works_sociology_from_bq.csv")
    save_data_to_bq(
